...
#[tokio::test]
async fn wasm_host_routes_permission_approval() {
    ...
    let declarations = host.ui_declarations().await.expect("建立权限插件 UI 路由");
